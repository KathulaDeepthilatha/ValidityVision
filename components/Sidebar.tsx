...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-72 h-full bg-surface-light/90 dark:bg-surface-dark/90 backdrop-blur-xl flex flex-col border-r border-slate-200 dark:border-slate-800 shrink-0 z-30 shadow-xl transition-all duration-500 relative hidden md:flex">
